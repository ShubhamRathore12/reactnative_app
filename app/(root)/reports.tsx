...
export default function ReportsScreen() {
  ...
  const downloadCSV = async (data: any[]) => {
    try {
      ...
      // Save file
      const fileName = `grain_report_${new Date().toISOString().split('T')[0]}.csv`;
  ...
  const downloadExcel = async (data: any[]) => {
    try {
      ...
      const fileName = `grain_report_${new Date().toISOString().split('T')[0]}.html`;
      const fileUri = FileSystem.documentDirectory + fileName;
          ...
          >
            <View style={styles.buttonContent}>
              ...
              <View style={styles.buttonText}>
                ...
                <Text style={styles.buttonSubtitle}>Comma-separated values</Text>
              </View>
